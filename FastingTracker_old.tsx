                ...
                <div className="bg-slate-900 rounded-3xl shadow-sm p-8 border border-slate-800 text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10 max-w-md mx-auto">
                        ...
                        <div className="space-y-3 mb-8">
                            ...
                            <div className="flex items-center gap-3 text-sm text-slate-300 bg-slate-800/50 p-3 rounded-xl border border-slate-700"><IconCheckCircle className="w-5 h-5 text-emerald-500" /> Suivi m├®tabolique en temps r├®el</div>
                            <div className="flex items-center gap-3 text-sm text-slate-300 bg-slate-800/50 p-3 rounded-xl border border-slate-700"><IconCheckCircle className="w-5 h-5 text-emerald-500" /> Statistiques d'autophagie et de c├®tose</div>
                        </div>
                            ...
                            activeFast ? (
                                <div className="text-center py-4">
                                    <div className="relative w-48 h-48 mx-auto mb-8 flex items-center justify-center">
                                        ...
                                        <div className="relative"><p className="text-4xl font-bold tracking-tighter text-white">{hours}:{minutes}:{seconds}</p><p className="text-xs text-slate-500 uppercase tracking-widest mt-1">Je├╗ne Actif</p></div>
                                    </div>
                            ...
                            <ResponsiveContainer width="100%" height="100%">
                                <BarChart data={historyData} margin={{ top: 5, right: 10, left: -20, bottom: 5 }}>
                                    ...
                                    <Tooltip
                                        ...
                                        formatter={(value: number) => [`${value} h`, historyView === 'year' ? 'Total heures' : 'Dur├®e']}
                                    />
