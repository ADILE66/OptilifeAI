                    ...
                    {step === 4 && (
                        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label className="text-sm font-bold text-slate-400 uppercase mb-2 block">├ége</label>
                                ...
                                <div className="sm:col-span-2">
                                    <label className="text-sm font-bold text-slate-400 uppercase mb-2 block">Niveau d'activit├®</label>
                            ...
                            {isAnalyzing ? (
                                <div className="space-y-6">
                                    ...
                                    <div className="max-w-xs mx-auto space-y-2">
                                        ...
                                        <p className="text-xs text-slate-400 uppercase tracking-widest">IA en cours de r├®flexion...</p>
                                    </div>
                                </div>
                            ) : (
                                <div className="space-y-6">
                                    ...
                                    <div className="bg-emerald-50 p-6 rounded-2xl border border-emerald-100 max-w-sm mx-auto text-left space-y-4">
                                        <div className="flex gap-3">
                                            ...
                                            <p className="text-sm text-slate-700">Objectif calorie calcul├® : <strong>2400 kcal</strong></p>
                                        </div>
                                        <div className="flex gap-3">
                                        ...
                                        <div className="flex gap-3">
                                            ...
                                            <p className="text-sm text-slate-700">R├®cup├®ration conseill├®e : <strong>8h / nuit</strong></p>
                                        </div>
                                    </div>
                                </div>
                            )}
