            ...
            <main className="pt-20">
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="text-center mb-20">
                            ...
                            <p className="text-slate-400 text-lg max-w-2xl mx-auto font-medium">
                                La santé n'est pas un silo. Notre IA synchronise ces 5 piliers pour vous offrir une vision à 360° que les autres applications ignorent.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            <ModuleCard
                                ...
                                description="Plus besoin de peser vos aliments. Prenez une photo, l'IA identifie les macros et les calories instantanément."
                                benefit="Équilibre métabolique"
                            ...
                            <ModuleCard
                                ...
                                description="Optimisez votre clarté mentale. Un suivi intelligent qui s'adapte à votre activité physique et à la météo."
                                benefit="Focus & Énergie"
                                color="text-blue-400"
                                bg="bg-blue-500/10"
                            ...
                            <ModuleCard
                                icon={IconActivity}
                                title="Mouvement & GPS"
                                description="Suivi en direct de vos séances de sport avec podomètre et tracé GPS. Visualisez votre impact calorique réel."
                            ...
                            <ModuleCard
                                icon={IconClock}
                                title="Jeûne Rythmique"
                                description="Maîtrisez vos cycles d'autophagie (16:8, OMAD) avec un minuteur intelligent et un suivi des phases métaboliques."
                            ...
                            <ModuleCard
                                icon={IconMoon}
                                title="Sommeil & Récup"
                                description="Analysez la qualité de vos nuits. L'IA corrèle votre sommeil avec votre alimentation pour optimiser votre repos."
                                benefit="Récupération profonde"
                            ...
                            <div className="bg-slate-800 rounded-[3rem] p-10 flex flex-col items-center text-center text-white justify-center shadow-2xl relative overflow-hidden group border border-slate-700">
                                ...
                                <h3 className="text-2xl font-black mb-4 tracking-tight">Le Cœur : Intelligence Fusion</h3>
                                <p className="text-slate-400 text-sm leading-relaxed mb-8">
                                    Notre algorithme propriétaire lie vos 5 modules. Il détecte pourquoi vous êtes fatigué et ajuste vos objectifs en temps réel.
                                </p>
                        ...
                        <div className="flex flex-col lg:flex-row items-center gap-20">
                            <div className="flex-1 text-center lg:text-left">
                                ...
                                <p className="text-slate-400 text-xl mb-10 font-medium leading-relaxed">
                                    Contrairement aux trackers classiques, OptiLife utilise des modèles de vision et de langage multimodaux pour analyser vos habitudes complexes.
                                </p>

                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-left">
                                    <IAFeature
                                        title="Analyse Multimodale"
                                        desc="Envoyez une photo ou parlez à l'application. Elle comprend tout, du plat de pâtes au sentiment de fatigue."
                                    />
                                    <IAFeature
                                        title="Prédictions Santé"
                                        desc="L'IA anticipe vos baisses d'énergie basées sur votre hydratation et votre sommeil des 48 dernières heures."
                                    />
                                    <IAFeature
                                        title="Chef IA Personnalisé"
                                        desc="Générez des recettes basées sur vos macros manquantes et ce qu'il reste dans votre frigo."
                                    />
                                    <IAFeature
                                    ...
                                    <div className="aspect-[4/5] bg-slate-800 rounded-[3rem] overflow-hidden relative group">
                                        ...
                                        <div className="absolute inset-0 flex flex-col items-center justify-center p-10">
                                            ...
                                            <div className="w-full bg-brand-600 p-4 rounded-2xl flex items-center gap-3 shadow-2xl">
                                                ...
                                                <p className="text-[10px] font-black text-white uppercase tracking-widest">IA en écoute...</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <section id="pricing" className="py-24 lg:py-32 bg-slate-900 scroll-mt-20">
                    <div className="max-w-5xl mx-auto px-6 text-center">
                        <h2 className="text-4xl md:text-6xl font-black text-white mb-8 tracking-tighter">Investissez dans votre longévité.</h2>
                        <p className="text-slate-400 text-lg mb-16 max-w-2xl mx-auto font-medium">Une tarification simple pour des résultats durables. Commencez gratuitement et passez à Pro quand vous êtes prêt.</p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-4xl mx-auto items-stretch">
                            ...
                            <div className="bg-slate-950 p-12 rounded-[3.5rem] border border-slate-800 shadow-xl flex flex-col text-left group hover:-translate-y-2 transition-transform duration-500">
                                <div className="mb-8">
                                    ...
                                    <div className="text-6xl font-black text-white tracking-tighter italic">0€</div>
                            ...
                            <div className="bg-slate-800 p-12 rounded-[3.5rem] border border-slate-700 shadow-2xl relative overflow-hidden flex flex-col text-left transform lg:scale-105 z-10 group">
                                <div className="absolute top-0 right-0 bg-brand-600 text-white px-8 py-3 rounded-bl-3xl font-black text-[10px] uppercase tracking-widest shadow-lg">Recommandé</div>
                                <div className="mb-8">
                                    <p className="text-slate-400 font-black uppercase tracking-widest text-[10px] mb-4">Coaching Premium</p>
                                    <div className="flex items-end gap-2">
                                        <span className="text-7xl font-black text-white tracking-tighter italic">{billingCycle === 'monthly' ? '9' : '7'}€</span>
                ...
                <section className="py-24 text-center bg-slate-950 relative overflow-hidden">
                    ...
                    <div className="max-w-4xl mx-auto px-6 relative z-10">
                        <h2 className="text-4xl md:text-7xl font-black text-white mb-10 tracking-tighter leading-tight italic">Redéfinissez vos limites. <br />Dès aujourd'hui.</h2>
                        <p className="text-slate-400 text-xl mb-14 font-medium max-w-2xl mx-auto">Rejoignez 15,000+ utilisateurs qui ont repris le contrôle de leur vitalité avec l'IA.</p>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-12 text-center md:text-left">
                        <div>
                            ...
                            <p className="text-slate-400 font-medium text-sm max-w-xs">L'application de santé la plus avancée au monde, conçue pour votre longévité.</p>
                        </div>
                    ...
                    <div className="mt-20 pt-8 border-t border-slate-900 flex flex-col md:flex-row justify-between items-center gap-4">
                        <p className="text-slate-600 font-bold text-[10px] uppercase tracking-widest">© 2024 OptiLife AI. Tous droits réservés.</p>
