    ...
    <div className="space-y-6">
      ...
      <div className="bg-slate-900 rounded-[2.5rem] shadow-sm p-8 border border-slate-800 overflow-hidden relative">
          ...
          {weightLogs.length > 0 ? (
            <ResponsiveContainer width="100%" height="100%">
              <ComposedChart data={weightChartData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                ...
                {/* Zones de sant├® IMC - Dark Mode Colors */}
            ...
            <div className="flex flex-col items-center justify-center h-full text-slate-500 bg-slate-800 rounded-3xl border-2 border-dashed border-slate-700 p-8">
              ...
              <p className="text-xs mt-2 max-w-[200px] text-center opacity-60">Ajoutez votre poids dans les param├¿tres pour commencer le suivi.</p>
            </div>
          )}
        </div>
        ...
        <div className="grid grid-cols-4 gap-1 mt-6">
          ...
          <div className="h-1 bg-red-500/30 rounded-full" title="Ob├®sit├®"></div>
        </div>
      </div>
      ...
      <div className="bg-slate-900 p-6 rounded-2xl shadow-sm border border-slate-800">
        <div className="flex justify-between items-start mb-6">
          ...
          <div className="flex items-center gap-2 text-right">
            ...
            <button onClick={handlePrevPeriod} className="p-1 rounded-md text-slate-400 hover:bg-slate-800 hover:text-slate-200" aria-label="P├®riode pr├®c├®dente"><IconChevronLeft className="w-5 h-5" /></button>
            <button onClick={handleNextPeriod} disabled={isNextDisabled()} className="p-1 rounded-md text-slate-400 hover:bg-slate-800 hover:text-slate-200 disabled:opacity-50 disabled:cursor-not-allowed" aria-label="P├®riode suivante"><IconChevronRight className="w-5 h-5" /></button>
          </div>
        </div>
